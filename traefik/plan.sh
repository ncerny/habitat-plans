...
pkg_source="https://github.com/containous/${pkg_name}/releases/download/v${pkg_version}/${pkg_name}_v${pkg_version}_linux_amd64.tar.gz"
...
do_install() {
  install -D $HAB_CACHE_SRC_PATH/traefik $pkg_prefix/bin/traefik
}
